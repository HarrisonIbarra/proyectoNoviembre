...
<head>
  ...
  <link rel="stylesheet" href="../styles_cliente/accesorios.css">
...
<body>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="sing up.html" type="button" class="btn btn-secondary agregar" data-dismiss="modal">agregar al carrito</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="productModal3" tabindex="-1" role="dialog" aria-labelledby="productModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="../vistas/sing up.html" type="button" class="btn btn-secondary agregar" data-dismiss="modal">agregar al carrito</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="productModal4" tabindex="-1" role="dialog" aria-labelledby="productModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="../imagenes/imagenes/moto2.jpg" type="button" class="btn btn-secondary agregar" data-dismiss="modal">agregar al carrito</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="productModal6" tabindex="-1" role="dialog" aria-labelledby="productModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <!-- <a href="../vistas/sing up.html"class="agregar"> al carrito</a> -->
        </div>
      </div>
    </div>
  </div>
  ...
  <nav aria-label="...">
    <ul class="pagination pagination-lg">
      ...
      <li class="page-item"><a class="page-link" href="../vistas/accesorios2.html">Siguiente</a></li>
    </ul>
  </nav>
  <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"></script>
