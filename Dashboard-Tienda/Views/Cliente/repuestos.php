...
<head>
  ...
  <link rel="stylesheet" href="../styles_cliente/repuestos.css">
  ...
  <div class="row col-ms-3 col-ms-3 col-ms-3 ">
    <div class="col">
      ...
      <div class="card h-100">
        <img src="../imagenes/imagenes/moto3.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          ...
          <div class="container text-center">
            <div class="row m-0">
              <div class="col-6 imagen-produ">
                <img src="../imagenes/imagenes/moto4.jpg" alt="">
              </div>
              <div class="col-6">
